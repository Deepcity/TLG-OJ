...
layui.define(['jquery','layer','cropper'],function (exports) {
    var $ = layui.jquery
        ,layer = layui.layer;
    var html = "<link rel=\"stylesheet\" href=\"/tlgoj/layui/modules/css/cropper.css\">\n" +
                    ...
                    image.cropper("getCroppedCanvas",{
                        ...
                        $.ajax({
                            ...
                            success:function(result){
                                ...
                                if(result.code == 0){
                                    console.log("croppers 运行成功");
                                    layer.msg(result.msg,{icon: 1});
                                    layer.closeAll('page');
                                    return done(result.data);
                                }else if(result.code == -1){
                                    console.log("croppers 运行失败");
                                    layer.alert(result.msg,{icon: 2});
                                }else {
                                    console.log("croppers 发生了意料之外的错误");
                                }
