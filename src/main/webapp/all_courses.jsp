...
<div class="layui-container">
                ...
                <div class="layui-inline" style="width: 80%">
                    <div class="layui-input-inline" style="width: 100%">
                        <input type="text" name="searchParam" autocomplete="off"
                               placeholder="CID、课程名" class="layui-input">
                    </div>
                </div>
    ...
    <table id="page_course" lay-filter="test"></table>
...
<script type="text/javascript">
    layui.use(['table'], function () {
        ...
        var myDone = function (res) {
            var tbl = $('#page_course').next('.layui-table-view');
            ...
            //.遍历当前页数据，对比已选中项中的 id
            for (var i = 0; i < len; i++) {
                if (layui.data('checked', pageData[i]['cid'])) {
            ...
            if (obj.event === 'add') {
                ...
                if (mySelected.length == 0) {
                    ...
                    for (let i = 0; i < mySelected.length; i++)
                        str += mySelected[i].cid + ",";
                    layer.confirm('确定要删除吗？', {icon: 3, title: "提示"}, function (index) {
                        $.post('delCourse', "cids=" + str, function (d) {
                            if (d.code == 0) {
                                table.reload("page_course");
                ...
                if (mySelected.length == 0) {
                    ...
                    layer.open({
                        ...
                        moveOut: false,
                        area: ['500px', '500px'],
                        content: 'addCourseByCourse.html'
                        , resize: false
        ...
        table.on('tool(test)', function (obj) {
            ...
            if (event == 'edit') {
                ...
                layer.confirm('确定要删除吗？', {icon: 3, title: "提示"}, function (index) {
                    $.post('delCourse', "cids=" + data.cid, function (d) {
                        if (d.code == 0) {
                            table.reload("page_course");
                            layer.msg("删除了" + d.msg + "条数据");
                        } else {
